...
asset 463efba8db29928601b7.js 25.7 KiB [emitted] [immutable] (name: main)
asset c4c1c519370341f3a157.js 15.3 KiB [emitted] [immutable]
chunk (runtime: main) 463efba8db29928601b7.js (main) 8.58 KiB (javascript) 5.02 KiB (runtime) [entry] [rendered]
  > ./example main
...
asset 78d2b2150bb8ae79ec50.js 8.6 KiB [emitted] [immutable] [minimized] (name: main) 1 related asset
asset 7ba29fd6aa9eec2acaae.js 4.68 KiB [emitted] [immutable] [minimized] 1 related asset
chunk (runtime: main) 78d2b2150bb8ae79ec50.js (main) 8.58 KiB (javascript) 5.02 KiB (runtime) [entry] [rendered]
  > ./example main
  runtime modules 5.02 KiB 6 modules
  dependent modules 8.54 KiB [dependent] 3 modules
  ./example.js 42 bytes [built] [code generated]
