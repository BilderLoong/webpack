...
/** @typedef {import("./EntryPlugin")} EntryPlugin */
...
class Compiler {
	 ...
	 * @returns {void}
	 * NOTE@HZL https://github.com/gweid/webpack-source-code#3compilerrun
	 */
	run(callback) {
		if (this.running) {
...
${other}`);
	 ...
	 * @returns {void}
	 * NOTE@HZL https://github.com/gweid/webpack-source-code#4compilercompile-
	 */
	compile(callback) {
		...
		this.hooks.beforeCompile.callAsync(params, err => {
			...
			/**
			 * NOTE@HZL
			 * @see {EntryPlugin} will listen this hook and start reading entry file.
			 * [Place use Compilation to exec builder](https://github.com/gweid/webpack-source-code#2compilation-%E7%9A%84%E8%B0%83%E7%94%A8%E6%97%B6%E6%9C%BA)
